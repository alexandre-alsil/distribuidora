...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cliente2.getTelefone().addAll(Arrays.asList("333333333", "444444444"));
		cliente3.getTelefone().addAll(Arrays.asList("555555555", "666666666"));
		cliente4.getTelefone().addAll(Arrays.asList("777777777", "888888888"));
		f1.getTelefone().addAll(Arrays.asList("123456789", "234567890"));
		f2.getTelefone().addAll(Arrays.asList("345678901", "456789032"));
		f3.getTelefone().addAll(Arrays.asList("567890321", "678903214"));
